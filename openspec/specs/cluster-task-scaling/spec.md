# Cluster Task Scaling Specification

## Purpose

Define same-source cluster admission, byte-based progress reporting, bounded streaming scan behavior, and failure semantics for large-directory cluster tasks in DiagnoseToolPy.
