...
- [ ] Implement the bugfix prompt exporter
...
- [ ] Add the bugfix prompt export API
...
- [ ] Add frontend entry points for bugfix prompt export
...
- [ ] Update docs and project continuity snapshot
