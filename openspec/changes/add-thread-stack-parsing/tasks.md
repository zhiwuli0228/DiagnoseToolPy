...
- [x] 1.1 Add `diagnose_tool/analyzer/thread_stack_parser.py` with a pure parser for common JVM thread dump blocks
...
- [x] 1.2 Keep the parser conservative on malformed or unsupported vendor formats
...
- [x] 2.1 Add focused parser tests for metadata and frame ordering
...
- [x] 2.2 Confirm the existing JVM exception stack parser remains unchanged
...
- [x] 3.1 Document thread dump parsing support in the log format guide
...
- [x] 3.2 Update the project continuity snapshot after implementation
